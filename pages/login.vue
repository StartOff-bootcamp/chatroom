...
<template>
  ...
  >
    <div class="max-w-md w-full space-y-8">
      ...
      <div
        v-if="error"
        class="bg-danger bg-opacity-10 text-danger px-4 py-2 rounded-lg text-center"
      >
        {{ error }}
      </div>
      ...
      <div
        v-if="successMessage"
        class="bg-success bg-opacity-10 text-success px-4 py-2 rounded-lg text-center"
      >
        {{ successMessage }}
      </div>
      ...
      <div class="flex flex-col space-y-6">
        ...
        <div class="relative">
          ...
          <div class="relative flex justify-center text-sm">
            <span class="px-2 bg-background text-gray-500">Of</span>
          </div>
        </div>
